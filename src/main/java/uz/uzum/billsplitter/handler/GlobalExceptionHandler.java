package uz.uzum.billsplitter.handler;
...
import uz.uzum.billsplitter.dto.error.ErrorDto;
import uz.uzum.billsplitter.exception.ApplicationException;

import static uz.uzum.billsplitter.constant.enums.Error.EXTERNAL_SERVICE_FAILED_ERROR_CODE;
import static uz.uzum.billsplitter.constant.enums.Error.HANDLER_NOT_FOUND_ERROR_CODE;
import static uz.uzum.billsplitter.constant.enums.Error.INTERNAL_SERVICE_ERROR_CODE;
import static uz.uzum.billsplitter.constant.enums.Error.INTERNAL_TIMEOUT_ERROR_CODE;
import static uz.uzum.billsplitter.constant.enums.Error.INVALID_REQUEST_PARAM_ERROR_CODE;
import static uz.uzum.billsplitter.constant.enums.Error.JSON_NOT_VALID_ERROR_CODE;
import static uz.uzum.billsplitter.constant.enums.Error.METHOD_NOT_SUPPORTED_ERROR_CODE;
import static uz.uzum.billsplitter.constant.enums.Error.MISSING_REQUEST_HEADER_ERROR_CODE;
import static uz.uzum.billsplitter.constant.enums.Error.VALIDATION_ERROR_CODE;
import static uz.uzum.billsplitter.constant.enums.ErrorType.EXTERNAL;
import static uz.uzum.billsplitter.constant.enums.ErrorType.INTERNAL;
import static uz.uzum.billsplitter.constant.enums.ErrorType.VALIDATION;
